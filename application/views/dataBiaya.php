                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="form-group">
                                        <label for="InputNIS">Tingkat Sekolah</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="InputNama" aria-describedby="InputNama">
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="form-group">
                                        <label for="InputNIS">Tingkat Sekolah</label>
                                        <input type="text" value="TK" class="form-control" id="InputNIS" aria-describedby="InputNIS">
                                        <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                    </div>
                                    <div class="form-group">
                                        <label for="InputNama">Biaya</label>
