        ...
        <div class="container mt-4 main-container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body" style="border-left:4px solid #1AAF45; border-right: 4px solid #1AAF45; border-radius: 5px;">
                            <div class="media">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body" style="border-left:4px solid #0A8CF8; border-right: 4px solid #0A8CF8; border-radius: 5px;">
                            <div class="media">
                                <div class="media-body">
                                        <p class="content-color-secondary mb-0">Total Transaksi</p>
